...
const NavigationBar = (props) => {
  ...
  return (
    ...
    >
      ...
      <List>
        <NavLink
          activeClassName={(() => {setCurrentNavLink('Home'); return 'nav--active-listitem'})()}
        ...
        <NavLink
          activeClassName={(() => {setCurrentNavLink('About'); return 'nav--active-listitem'})()}
          className={'nav--listitem'}
          to={'/About'}
        >
          <ListItem>
        ...
        <NavLink
          activeClassName={(() => {setCurrentNavLink('Portofolio'); return 'nav--active-listitem'})()}
          className={'nav--listitem'}
          to={'/Portofolio'}
        >
          <ListItem>
